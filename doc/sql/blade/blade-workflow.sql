...
INSERT INTO `act_ge_property` VALUES ('cfg.execution-related-entities-count','true',1),('cfg.task-related-entities-count','true',1),('common.schema.version','7.1.0.2',1),('eventregistry.schema.version','7.1.0.2',1),('next.dbid','7501',4),('schema.history','create(7.1.0.2)',1),('schema.version','7.1.0.2',1);
...
CREATE TABLE `wf_instance` (
  ...
  `is_deleted` int NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `is_test` tinyint NOT NULL DEFAULT '0' COMMENT '测试态标记 1=测试产生的实例/数据',
  `test_deployment_id` varchar(64) DEFAULT NULL COMMENT '测试临时部署ID（清理时级联卸载）',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2100201301154529283 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='流程出口（连线）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2100191851668635651 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='流程节点';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wf_task` (
  ...
  `is_deleted` int NOT NULL DEFAULT '0' COMMENT '逻辑删除',
  `is_test` tinyint NOT NULL DEFAULT '0' COMMENT '测试态标记 1=测试产生的待办',
  PRIMARY KEY (`id`),
...
CREATE TABLE `wf_test_log` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `def_id` bigint unsigned NOT NULL COMMENT '流程定义ID',
  `def_version` int DEFAULT NULL COMMENT '测试时的流程版本',
  `proc_key` varchar(100) DEFAULT NULL COMMENT '引擎流程Key（冗余，便于检索）',
  `def_name` varchar(200) DEFAULT NULL COMMENT '流程名称（冗余）',
  `test_user_id` bigint NOT NULL COMMENT '测试发起人用户ID',
  `test_user_name` varchar(100) DEFAULT NULL COMMENT '测试发起人姓名（冗余）',
  ...
  `summary` varchar(1000) DEFAULT NULL COMMENT '结论摘要',
  `log_content` longtext COMMENT '测试日志正文（逐行文本）',
  `result_json` json DEFAULT NULL COMMENT '结构化结果：节点经过次数/路径/操作者',
  `tenant_id` varchar(32) NOT NULL DEFAULT '000000' COMMENT '租户ID',
  `create_user` bigint DEFAULT NULL COMMENT '创建人',
  `create_dept` bigint DEFAULT NULL COMMENT '创建部门',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=2100399131932545026 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='流程测试日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wf_test_log` VALUES (2100399131932545025,2099758062693871618,4,'flow_mu180u86md3e','测试914',2019979771992432642,'test1','2026-09-17 09:39:11',327,1,10,10,1,'测试通过：流程从创建节点走通到归档节点，共 10 个节点，各节点操作者均能解析。','发起人身份：test1（2019979771992432642）\n流程：测试914（V4）\n-----------------------------------------\n2026-09-17 09:39:10 到达节点\"开始\"，操作者\"无\"；\n2026-09-17 09:39:10 通过节点\"开始\"；\n2026-09-17 09:39:10 执行出口\"3\"；\n2026-09-17 09:39:10 到达节点\"3\"，操作者\"无\"；\n2026-09-17 09:39:10 通过节点\"3\"；\n2026-09-17 09:39:10 执行出口\"中间事件\"；\n2026-09-17 09:39:10 到达节点\"中间事件\"，操作者\"无\"；\n2026-09-17 09:39:10 通过节点\"中间事件\"；\n2026-09-17 09:39:10 执行出口\"6\"；\n2026-09-17 09:39:10 到达节点\"6\"，操作者\"test1（2019979771992432642），testFind（2044030517948477441）\"；\n2026-09-17 09:39:10 通过节点\"6\"；\n2026-09-17 09:39:10 执行出口\"结束\"；\n2026-09-17 09:39:10 到达节点\"结束\"，操作者\"无\"；\n2026-09-17 09:39:10 流程已到达归档节点\"结束\"，测试完成\n2026-09-17 09:39:10 执行出口\"中间事件\"；\n2026-09-17 09:39:10 到达节点\"中间事件\"，操作者\"无\"；\n2026-09-17 09:39:10 通过节点\"中间事件\"；\n2026-09-17 09:39:10 执行出口\"中间事件\"；\n2026-09-17 09:39:10 到达节点\"中间事件\"，操作者\"无\"；\n2026-09-17 09:39:10 通过节点\"中间事件\"；\n2026-09-17 09:39:10 执行出口\"5\"；\n2026-09-17 09:39:10 到达节点\"5\"，操作者\"test1（2019979771992432642），testFind（2044030517948477441），test2（2020463343744380930）\"；\n2026-09-17 09:39:10 通过节点\"5\"；\n2026-09-17 09:39:10 执行出口\"结束\"；\n2026-09-17 09:39:10 到达节点\"结束\"，操作者\"无\"；\n2026-09-17 09:39:10 流程已到达归档节点\"结束\"，测试完成\n2026-09-17 09:39:10 执行出口\"1\"；\n2026-09-17 09:39:10 到达节点\"1\"，操作者\"test1（2019979771992432642），testFind（2044030517948477441）\"；\n2026-09-17 09:39:10 通过节点\"1\"；\n2026-09-17 09:39:10 执行出口\"当 tes 大于 100\"；\n2026-09-17 09:39:10 到达节点\"结束\"，操作者\"无\"；\n2026-09-17 09:39:10 流程已到达归档节点\"结束\"，测试完成\n2026-09-17 09:39:10 执行出口\"2\"；\n2026-09-17 09:39:10 到达节点\"2\"，操作者\"2036826812715196418（2036826812715196418），2042170824913412098（2042170824913412098），2045299268400508929（2045299268400508929），微信用户（2049417585025458177），用户7960（2051983659671547905）\"；\n2026-09-17 09:39:10 通过节点\"2\"；\n2026-09-17 09:39:10 执行出口\"结束\"；\n2026-09-17 09:39:10 到达节点\"结束\"，操作者\"无\"；\n2026-09-17 09:39:10 流程已到达归档节点\"结束\"，测试完成','{\"log\": [\"发起人身份：test1（2019979771992432642）\", \"流程：测试914（V4）\", \"-----------------------------------------\", \"2026-09-17 09:39:10 到达节点\\\"开始\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"开始\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"3\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"3\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"3\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"中间事件\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"中间事件\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"中间事件\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"6\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"6\\\"，操作者\\\"test1（2019979771992432642），testFind（2044030517948477441）\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"6\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"结束\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"结束\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 流程已到达归档节点\\\"结束\\\"，测试完成\", \"2026-09-17 09:39:10 执行出口\\\"中间事件\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"中间事件\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"中间事件\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"中间事件\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"中间事件\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"中间事件\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"5\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"5\\\"，操作者\\\"test1（2019979771992432642），testFind（2044030517948477441），test2（2020463343744380930）\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"5\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"结束\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"结束\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 流程已到达归档节点\\\"结束\\\"，测试完成\", \"2026-09-17 09:39:10 执行出口\\\"1\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"1\\\"，操作者\\\"test1（2019979771992432642），testFind（2044030517948477441）\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"1\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"当 tes 大于 100\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"结束\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 流程已到达归档节点\\\"结束\\\"，测试完成\", \"2026-09-17 09:39:10 执行出口\\\"2\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"2\\\"，操作者\\\"2036826812715196418（2036826812715196418），2042170824913412098（2042170824913412098），2045299268400508929（2045299268400508929），微信用户（2049417585025458177），用户7960（2051983659671547905）\\\"；\", \"2026-09-17 09:39:10 通过节点\\\"2\\\"；\", \"2026-09-17 09:39:10 执行出口\\\"结束\\\"；\", \"2026-09-17 09:39:10 到达节点\\\"结束\\\"，操作者\\\"无\\\"；\", \"2026-09-17 09:39:10 流程已到达归档节点\\\"结束\\\"，测试完成\"], \"path\": [{\"toNodeKey\": \"UserTask_mu2c2p880\", \"conditionCn\": \"\", \"fromNodeKey\": \"StartEvent_mu2c2p840\"}, {\"toNodeKey\": \"Event_093p7s3\", \"conditionCn\": \"\", \"fromNodeKey\": \"UserTask_mu2c2p880\"}, {\"toNodeKey\": \"Activity_02klewn\", \"conditionCn\": \"\", \"fromNodeKey\": \"Event_093p7s3\"}, {\"toNodeKey\": \"EndEvent_mu2c2p8c0\", \"conditionCn\": \"\", \"fromNodeKey\": \"Activity_02klewn\"}, {\"toNodeKey\": \"Event_0ctoqxr\", \"conditionCn\": \"\", \"fromNodeKey\": \"Event_093p7s3\"}, {\"toNodeKey\": \"Event_0pivae0\", \"conditionCn\": \"\", \"fromNodeKey\": \"Event_0ctoqxr\"}, {\"toNodeKey\": \"Activity_0ylt45t\", \"conditionCn\": \"\", \"fromNodeKey\": \"Event_0pivae0\"}, {\"toNodeKey\": \"EndEvent_mu2c2p8c0\", \"conditionCn\": \"\", \"fromNodeKey\": \"Activity_0ylt45t\"}, {\"toNodeKey\": \"Activity_0qm5tc6\", \"conditionCn\": \"\", \"fromNodeKey\": \"UserTask_mu2c2p880\"}, {\"toNodeKey\": \"EndEvent_mu2c2p8c0\", \"conditionCn\": \"当 tes 大于 100\", \"fromNodeKey\": \"Activity_0qm5tc6\"}, {\"toNodeKey\": \"Activity_1mzuxt6\", \"conditionCn\": \"\", \"fromNodeKey\": \"UserTask_mu2c2p880\"}, {\"toNodeKey\": \"EndEvent_mu2c2p8c0\", \"conditionCn\": \"\", \"fromNodeKey\": \"Activity_1mzuxt6\"}], \"logId\": null, \"nodes\": [{\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"Activity_02klewn\", \"nodeName\": \"6\", \"nodeType\": 1, \"operators\": [{\"source\": \"操作者配置解析\", \"userId\": 2019979771992432642, \"userName\": \"test1\"}, {\"source\": \"操作者配置解析\", \"userId\": 2044030517948477441, \"userName\": \"testFind\"}], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"Activity_0qm5tc6\", \"nodeName\": \"1\", \"nodeType\": 1, \"operators\": [{\"source\": \"操作者配置解析\", \"userId\": 2019979771992432642, \"userName\": \"test1\"}, {\"source\": \"操作者配置解析\", \"userId\": 2044030517948477441, \"userName\": \"testFind\"}], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"Activity_0ylt45t\", \"nodeName\": \"5\", \"nodeType\": 1, \"operators\": [{\"source\": \"操作者配置解析\", \"userId\": 2019979771992432642, \"userName\": \"test1\"}, {\"source\": \"操作者配置解析\", \"userId\": 2044030517948477441, \"userName\": \"testFind\"}, {\"source\": \"操作者配置解析\", \"userId\": 2020463343744380930, \"userName\": \"test2\"}], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"Activity_1mzuxt6\", \"nodeName\": \"2\", \"nodeType\": 1, \"operators\": [{\"source\": \"操作者配置解析\", \"userId\": 2036826812715196418, \"userName\": \"2036826812715196418\"}, {\"source\": \"操作者配置解析\", \"userId\": 2042170824913412098, \"userName\": \"2042170824913412098\"}, {\"source\": \"操作者配置解析\", \"userId\": 2045299268400508929, \"userName\": \"2045299268400508929\"}, {\"source\": \"操作者配置解析\", \"userId\": 2049417585025458177, \"userName\": \"微信用户\"}, {\"source\": \"操作者配置解析\", \"userId\": 2051983659671547905, \"userName\": \"用户7960\"}], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"EndEvent_mu2c2p8c0\", \"nodeName\": \"结束\", \"nodeType\": 3, \"operators\": [], \"passTimes\": 4}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"Event_093p7s3\", \"nodeName\": \"中间事件\", \"nodeType\": 5, \"operators\": [], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"Event_0ctoqxr\", \"nodeName\": \"中间事件\", \"nodeType\": 5, \"operators\": [], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"Event_0pivae0\", \"nodeName\": \"中间事件\", \"nodeType\": 5, \"operators\": [], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"StartEvent_mu2c2p840\", \"nodeName\": \"开始\", \"nodeType\": 0, \"operators\": [], \"passTimes\": 1}, {\"status\": 1, \"message\": \"走通\", \"nodeKey\": \"UserTask_mu2c2p880\", \"nodeName\": \"3\", \"nodeType\": 6, \"operators\": [], \"passTimes\": 1}], \"costMs\": 327, \"summary\": \"测试通过：流程从创建节点走通到归档节点，共 10 个节点，各节点操作者均能解析。\", \"nodeTimes\": {\"Event_093p7s3\": 1, \"Event_0ctoqxr\": 1, \"Event_0pivae0\": 1, \"Activity_02klewn\": 1, \"Activity_0qm5tc6\": 1, \"Activity_0ylt45t\": 1, \"Activity_1mzuxt6\": 1, \"EndEvent_mu2c2p8c0\": 4, \"UserTask_mu2c2p880\": 1, \"StartEvent_mu2c2p840\": 1}, \"nodeTotal\": 10, \"nodePassed\": 10, \"reachedEnd\": true, \"testStatus\": 1}','000000',1123598821738675201,NULL,'2026-09-17 09:39:11',NULL,'2026-09-17 09:39:11',1,0);
...
-- Dump completed on 2026-09-17 11:18:36
